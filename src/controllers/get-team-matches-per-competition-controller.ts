...
class GetTeamsMatchesPerCompetition {
	...
	handle = async (request: Request, response: Response) => {
		...
		const data = await this.apiService.getTeamsMatchesPerCompetition(
			id,
			competitionId,
		)
...
export const GetTeamsMatchesPerCompetitionController =
	new GetTeamsMatchesPerCompetition(FootballDataService)
