...
export interface GetAllCompetitionsResponseType {
	count: number
	competitions: FormatedCompetition[]
}

export interface FormatedCompetition {
	id: number
	area: {
		name: string
		flag: string
...
export interface GetAllMatchesInACompetitionResponse {
	matches: FormatedMatch[]
}
...
export interface GetAllTeamsInACompetitionResponse {
	teams: FormatedTeam[]
}
...
export interface FormatedMatchWithCompetition extends FormatedMatch {
	competition: Competition
}
...
export interface GetTeamsMatchesPerCompetitionResponse {
	resultSet: ResultSet
	matches: FormatedMatchWithCompetition[]
}
